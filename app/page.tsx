...
// Menu items
const menuItems = ['A Empresa', 'Festivais', 'Artistas', 'Projetos', 'Contato']
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-dark-navy text-white font-inter selection:bg-gold-primary selection:text-black">
      {/* Navbar */}
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 border-b border-transparent ${scrolled ? 'bg-dark-navy/90 backdrop-blur-md border-white/10 py-4' : 'bg-transparent py-6'
          }`}
        >
